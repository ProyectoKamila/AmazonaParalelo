...
//var_dump($_POST);
$pkapi = new pkapi();
$precio = $pkapi->post('pedidoadolar/' . $_POST["pedido"]);
//var_dump($precio[$_POST["currencyCodeType"]]);
//var_dump(round($precio[$_POST["currencyCodeType"]],2));
//var_dump($precio);
//exit();
$_POST["METHOD"] = "SetExpressCheckout";
$_POST["paymentType"] = "Sale";
//<!-- Envio -->
$_POST["PAYMENTREQUEST_0_SHIPPINGAMT"] = "0";
//<!-- Cantidad -->
$_POST["L_PAYMENTREQUEST_0_QTY0"] = "1";
//<!-- Precio -->
$_POST["PAYMENTREQUEST_0_ITEMAMT"] = $precio[$_POST["currencyCodeType"]];
//<!-- Descuento -->
$_POST["PAYMENTREQUEST_0_SHIPDISCAMT"] = "0";
//<!-- Total -->
$_POST["PAYMENTREQUEST_0_AMT"] = $precio[$_POST["currencyCodeType"]];
